...
const RouteFile = () => {
  var list=[
    {id:1,name:'Shiwani',age:26,course:"MERN",batch:"september"},
    {id:2,name:'Rohini',age:28,course:"MERN",batch:"october"},
    {id:3,name:'Ashwini',age:27,course:"MERN",batch:"November"},
